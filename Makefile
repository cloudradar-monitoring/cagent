...
aptly:
	...
	# Upload deb files
	rsync -e 'ssh -oStrictHostKeyChecking=no -p 24480' --recursive /go/src/github.com/cloudradar-monitoring/cagent/dist/*.deb  cr@repo.cloudradar.io:/home/cr/work/aptly/${CIRCLE_BUILD_NUM}/
...
createrepo:
	...
	# Upload rpm files
	rsync -e 'ssh -oStrictHostKeyChecking=no -p 24480' --recursive /go/src/github.com/cloudradar-monitoring/cagent/dist/*.rpm  cr@repo.cloudradar.io:/home/cr/work/rpm/${CIRCLE_BUILD_NUM}/
	# Trigger repository update
...
windows-sign:
	...
	scp -r -P 24481 -oStrictHostKeyChecking=no /go/src/github.com/cloudradar-monitoring/cagent/pkg-scripts/  hero@144.76.9.139:/cygdrive/C/Users/hero/ci/cagent_ci/build_msi/${CIRCLE_BUILD_NUM}
	scp -r -P 24481 -oStrictHostKeyChecking=no /go/src/github.com/cloudradar-monitoring/cagent/resources/  hero@144.76.9.139:/cygdrive/C/Users/hero/ci/cagent_ci/build_msi/${CIRCLE_BUILD_NUM}
	scp -P 24481 -oStrictHostKeyChecking=no /go/src/github.com/cloudradar-monitoring/cagent/example.config.toml hero@144.76.9.139:/cygdrive/C/Users/hero/ci/cagent_ci/build_msi/${CIRCLE_BUILD_NUM}/example.config.toml
	scp -P 24481 -oStrictHostKeyChecking=no /go/src/github.com/cloudradar-monitoring/cagent/README.md hero@144.76.9.139:/cygdrive/C/Users/hero/ci/cagent_ci/build_msi/${CIRCLE_BUILD_NUM}/README.md
	scp -P 24481 -oStrictHostKeyChecking=no /go/src/github.com/cloudradar-monitoring/cagent/LICENSE hero@144.76.9.139:/cygdrive/C/Users/hero/ci/cagent_ci/build_msi/${CIRCLE_BUILD_NUM}/LICENSE
	scp -P 24481 -oStrictHostKeyChecking=no /go/src/github.com/cloudradar-monitoring/cagent/wix.json hero@144.76.9.139:/cygdrive/C/Users/hero/ci/cagent_ci/build_msi/${CIRCLE_BUILD_NUM}/wix.json
	# Trigger msi creating
	ssh -p 24481 -oStrictHostKeyChecking=no hero@144.76.9.139 /cygdrive/C/Users/hero/ci/cagent_ci/build_msi/${CIRCLE_BUILD_NUM}/build-win.bat ${CIRCLE_BUILD_NUM} ${CIRCLE_TAG}
	# Trigger signing
	ssh -p 24481 -oStrictHostKeyChecking=no hero@144.76.9.139 curl --fail http://localhost:8080/?file=cagent_32.msi
	sleep 10
	ssh -p 24481 -oStrictHostKeyChecking=no hero@144.76.9.139 curl --fail http://localhost:8080/?file=cagent_64.msi
	# Copy msi files back to build machine
	scp -P 24481 -oStrictHostKeyChecking=no hero@144.76.9.139:/cygdrive/C/Users/hero/ci/cagent_32.msi /go/src/github.com/cloudradar-monitoring/cagent/dist/cagent_386.msi
	scp -P 24481 -oStrictHostKeyChecking=no hero@144.76.9.139:/cygdrive/C/Users/hero/ci/cagent_64.msi /go/src/github.com/cloudradar-monitoring/cagent/dist/cagent_64.msi
