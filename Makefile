...
windows-sign:
  ...
  # Copy MSI files back to build machine
	...
	rsync -e 'ssh -oStrictHostKeyChecking=no -p 24480' ${PROJECT_DIR}/dist/cagent_proprietary_386.msi cr@repo.cloudradar.io:/var/repos/cloudradar/windows/cagent/cagent_${CIRCLE_TAG}_Windows_386.msi
	rsync -e 'ssh -oStrictHostKeyChecking=no -p 24480' ${PROJECT_DIR}/dist/cagent_proprietary_64.msi cr@repo.cloudradar.io:/var/repos/cloudradar/windows/cagent/cagent_${CIRCLE_TAG}_Windows_64.msi
