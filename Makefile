...
windows-sign:
  ...
  # Copy MSI files back to build machine
	...
	scp -P 24480 -oStrictHostKeyChecking=no ${PROJECT_DIR}/dist/cagent_proprietary_386.msi cr@repo.cloudradar.io:/var/repos/cloudradar/windows/cagent/cagent_${CIRCLE_TAG}_Windows_386.msi
	scp -P 24480 -oStrictHostKeyChecking=no ${PROJECT_DIR}/dist/cagent_proprietary_64.msi cr@repo.cloudradar.io:/var/repos/cloudradar/windows/cagent/cagent_${CIRCLE_TAG}_Windows_64.msi
