...
COPY dist\cagent_windows_amd64\cagent.exe cagent.exe
COPY dist\csender_windows_amd64\csender.exe csender.exe
COPY dist\jobmon_windows_amd64\jobmon.exe jobmon.exe
